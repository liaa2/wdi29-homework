...
//     while(num % i === 0){
//       primeFactors.push(i);
//       console.log('found factor', i, primeFactors);
//       num = num / i;     // num /= i;
//       console.log('new num after div by i', num);
//     }
//     console.log('out of while; now test i <= num: ', i, num);
//   }
//   return primeFactors;
// }
// console.log(primeNumbers(60));
...
//       let isPrime = true;
//       let potentialPrime = arr[i];
//       for( let j = 0; j < potentialPrime; j++ ){
//         if (potentialPrime[i] % j === 0) {
//           isPrime = false;
//         }
//       }//for
//

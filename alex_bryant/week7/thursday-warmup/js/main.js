...
const spaceData = {
  ...
  secondsToYears: function (seconds, planet) {
    return (seconds / this.secondsInEarthYear) / this.orbitalPeriodYears[planet];
  },
  printResults: function(seconds, planets) {
    const self = this;
    planets.forEach(function(planet) {
      console.log(`You are ${self.secondsToYears(seconds, planet)} ${planet}-years old`);
    });
  }
}

console.log("All");
spaceData.printResults(1000000000, ['Earth', 'Mercury', 'Venus', 'Mars', 'Jupiter', 'Saturn', 'Uranus', 'Neptune']);
console.log("Individually");
spaceData.printResults(1000000000, ['Mercury']);
